...
def main(data_sets, module_name, **kwargs):
    ...
    if module_name == 'Parlour':
        model.set_hyper_params(kwargs['num_epochs'],
        ...
        model.set_hyper_params(kwargs['learning_rate'],
                               kwargs['num_epochs'],
                               kwargs['initialization'],
                               kwargs['minibatch_size'],
                               kwargs['layer_dims'],
    ...
    if module_name == 'Vieira':
        data_sets['train_y'] = data_utils.convert_to_one_hot(data_sets['train_y'],
                                                             len(data_sets['classes']))
        data_sets['test_y'] = data_utils.convert_to_one_hot(data_sets['test_y'],
                                                            len(data_sets['classes']))
...
if __name__ == '__main__':
    ...
    with open(args.params_file, 'r') as f:
        data_dict, deep_nn_hyper_params = model_utils.process_params_file(f, args.module_name)
