...
def gen_2D_data(n_samples=300, noise=.2):
    np.random.seed(3)
...
if __name__ == '__main__':
    ...
    print("Generate 2D Moon Trainig Dataset with {} samples and Gussian Noise \
           STD of {}".format(args.n_samples_train, args.noise_train))
    print("Generate 2D Moon Dev Dataset with {} samples and Gussian Noise \
           STD of {}".format(args.n_samples_dev, args.noise_dev))
    ...
    sio.savemat(args.output_file, {'train_x': train_X,
                                   'train_y': train_Y,
                                   'test_x': dev_X,
                                   'test_y': dev_Y})
